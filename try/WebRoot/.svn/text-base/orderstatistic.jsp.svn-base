...
<html lang="en">
	...
	<body style="padding-left:100px;padding-top:40px;padding-right:100px;">
		...
		<div class="page-header">
                    ...
                    <h1 style="font-family: 'Segoe UI', arial, sans-serif;">统计数据 <small>CUSTOMER RELATIONSHIP MANAGEMENT</small></h1>
                </div>
	...
	<div class="block">
							...
							<div class="block" style="padding-top:100px;">
								...
								<div class="data">
									<div id="chart-2" style="height: 300px; padding-right: 40px;"></div>
								</div>
