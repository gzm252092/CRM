	...
	<body style="padding-left:100px;padding-top:40px;padding-right:100px;">
		<div id="loader">
			<img src="img/loader.gif" />
						...
						<span id="title">销售计划>>添加</span>
						<div class="form">
							<form id="form">
								<table class="dt" width="600px;">
									<tr>
										...
										value="#session.user" readonly="readonly" />
									...
									<tr>
										...
										name="pvo.clientname" /> <span id="clientname"></span>
										</td>
										<td align="center">
											<label>
												成功率:
										...
										<td>
											<input type="text" name="pvo.chance" /> <span
										id="chance"></span>
										</td>
									</tr>
									<tr>
										...
										<td colspan="3">
											<input type="text" name="pvo.name" style="width: 350px"/> <span id="name"></span>
										</td>
									</tr>
									<tr>
										<td align="center">
									...
									<tr>
										...
										name="pvo.stime" /> <span id="stime"></span>
										...
										name="pvo.ftime" /> <span id="ftime"></span>
										</td>
									</tr>
								</table>
...
<script type="text/javascript">
	function show() {
		var data = $("#form").serialize() + "&pvo.styleid="+2+"&pvo.status=未分配";
		alert(data);
